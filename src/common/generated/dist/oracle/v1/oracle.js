...
exports.OracleScript = {
    ...
    decode(input, length) {
        const reader = input instanceof minimal_1.default.Reader ? input : new minimal_1.default.Reader(input);
        let end = length === undefined ? reader.len : reader.pos + length;
        const message = Object.assign({}, baseOracleScript);
        while (reader.pos < end) {
            const tag = reader.uint32();
            switch (tag >>> 3) {
                case 1:
...
exports.RawRequest = {
    ...
    decode(input, length) {
        const reader = input instanceof minimal_1.default.Reader ? input : new minimal_1.default.Reader(input);
        let end = length === undefined ? reader.len : reader.pos + length;
        const message = Object.assign({}, baseRawRequest);
...
const baseRawReport = { externalId: long_1.default.ZERO, exitCode: 0 };
exports.RawReport = {
    encode(message, writer = minimal_1.default.Writer.create()) {
        if (!message.externalId.isZero()) {
            writer.uint32(8).int64(message.externalId);
    ...
    decode(input, length) {
        const reader = input instanceof minimal_1.default.Reader ? input : new minimal_1.default.Reader(input);
        let end = length === undefined ? reader.len : reader.pos + length;
        const message = Object.assign({}, baseRawReport);
...
exports.Request = {
    ...
    toJSON(message) {
        ...
        if (message.rawRequests) {
            obj.rawRequests = message.rawRequests.map((e) => e ? exports.RawRequest.toJSON(e) : undefined);
        }
        else {
            obj.rawRequests = [];
        }
...
const baseReport = { validator: "", inBeforeResolve: false };
exports.Report = {
    encode(message, writer = minimal_1.default.Writer.create()) {
    ...
    decode(input, length) {
        const reader = input instanceof minimal_1.default.Reader ? input : new minimal_1.default.Reader(input);
        let end = length === undefined ? reader.len : reader.pos + length;
        const message = Object.assign({}, baseReport);
        message.rawReports = [];
        while (reader.pos < end) {
            const tag = reader.uint32();
            switch (tag >>> 3) {
    ...
    toJSON(message) {
        ...
        if (message.rawReports) {
            obj.rawReports = message.rawReports.map((e) => e ? exports.RawReport.toJSON(e) : undefined);
        }
        else {
            obj.rawReports = [];
        }
...
const baseOracleRequestPacketData = {
    clientId: "",
    oracleScriptId: long_1.default.ZERO,
...
exports.OracleRequestPacketData = {
    ...
    decode(input, length) {
        const reader = input instanceof minimal_1.default.Reader ? input : new minimal_1.default.Reader(input);
        let end = length === undefined ? reader.len : reader.pos + length;
        const message = Object.assign({}, baseOracleRequestPacketData);
        message.feeLimit = [];
        message.calldata = new Uint8Array();
        while (reader.pos < end) {
            const tag = reader.uint32();
...
const baseOracleRequestPacketAcknowledgement = { requestId: long_1.default.ZERO };
exports.OracleRequestPacketAcknowledgement = {
    ...
    decode(input, length) {
        const reader = input instanceof minimal_1.default.Reader ? input : new minimal_1.default.Reader(input);
        let end = length === undefined ? reader.len : reader.pos + length;
        const message = Object.assign({}, baseOracleRequestPacketAcknowledgement);
        while (reader.pos < end) {
            const tag = reader.uint32();
            switch (tag >>> 3) {
                case 1:
...
const baseOracleResponsePacketData = {
    clientId: "",
...
exports.OracleResponsePacketData = {
    ...
    decode(input, length) {
        const reader = input instanceof minimal_1.default.Reader ? input : new minimal_1.default.Reader(input);
        let end = length === undefined ? reader.len : reader.pos + length;
        const message = Object.assign({}, baseOracleResponsePacketData);
...
exports.RequestResult = {
    ...
    decode(input, length) {
        const reader = input instanceof minimal_1.default.Reader ? input : new minimal_1.default.Reader(input);
        let end = length === undefined ? reader.len : reader.pos + length;
        const message = Object.assign({}, baseRequestResult);
        while (reader.pos < end) {
            const tag = reader.uint32();
            switch (tag >>> 3) {
                case 1:
...
const baseValidatorStatus = { isActive: false };
exports.ValidatorStatus = {
    ...
    decode(input, length) {
        const reader = input instanceof minimal_1.default.Reader ? input : new minimal_1.default.Reader(input);
        let end = length === undefined ? reader.len : reader.pos + length;
        const message = Object.assign({}, baseValidatorStatus);
        while (reader.pos < end) {
            const tag = reader.uint32();
            switch (tag >>> 3) {
                case 1:
...
const basePendingResolveList = { requestIds: long_1.default.ZERO };
exports.PendingResolveList = {
    ...
    decode(input, length) {
        const reader = input instanceof minimal_1.default.Reader ? input : new minimal_1.default.Reader(input);
        let end = length === undefined ? reader.len : reader.pos + length;
        const message = Object.assign({}, basePendingResolveList);
        message.requestIds = [];
        while (reader.pos < end) {
            const tag = reader.uint32();
            switch (tag >>> 3) {
...
const baseIBCSource = { sourceChannel: "", sourcePort: "" };
exports.IBCSource = {
    encode(message, writer = minimal_1.default.Writer.create()) {
    ...
    decode(input, length) {
        const reader = input instanceof minimal_1.default.Reader ? input : new minimal_1.default.Reader(input);
        let end = length === undefined ? reader.len : reader.pos + length;
        const message = Object.assign({}, baseIBCSource);
        while (reader.pos < end) {
            const tag = reader.uint32();
            switch (tag >>> 3) {
                case 1:
...
exports.OraclePool = {
    ...
    decode(input, length) {
        const reader = input instanceof minimal_1.default.Reader ? input : new minimal_1.default.Reader(input);
        let end = length === undefined ? reader.len : reader.pos + length;
        const message = Object.assign({}, baseOraclePool);
    ...
    toJSON(message) {
        ...
        if (message.dataProvidersPool) {
            obj.dataProvidersPool = message.dataProvidersPool.map((e) => e ? coin_1.DecCoin.toJSON(e) : undefined);
        }
        else {
...
const baseDataProviderAccumulatedReward = { dataProvider: "" };
exports.DataProviderAccumulatedReward = {
    encode(message, writer = minimal_1.default.Writer.create()) {
    ...
    decode(input, length) {
        const reader = input instanceof minimal_1.default.Reader ? input : new minimal_1.default.Reader(input);
        let end = length === undefined ? reader.len : reader.pos + length;
        const message = Object.assign({}, baseDataProviderAccumulatedReward);
    ...
    toJSON(message) {
        ...
        if (message.dataProviderReward) {
            obj.dataProviderReward = message.dataProviderReward.map((e) => e ? coin_1.DecCoin.toJSON(e) : undefined);
        }
        else {
